#!/usr/bin/env bash
NEZHA_SERVER=${NEZHA_SERVER:-'myvps.lgf770.eu.org'}
NEZHA_PORT=${NEZHA_PORT:-'5555'}
NEZHA_KEY=${NEZHA_KEY:-'IjvlwnpWUmjK3OcNRj'}
TLS=${TLS:-'1'}
ARGO_DOMAIN=${ARGO_DOMAIN:-'fly.cfcloud.pp.ua'}
ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiODg0NTgzZTU4ZWZjYzdjY2E2MjJlNjViZWVhY2I2ZjkiLCJ0IjoiOTA1YzVkYzYtMzIxYy00ODQ5LTg1MWMtYWYyY2IzNzE5ODcxIiwicyI6Ik5tSTRObVF6WVRrdFpUQXlZUzAwTkRSakxUbGpZMlF0T1RRMU9EQTJNMll4Tm1ZeiJ9'}
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'9b594c3a-d68c-4d73-84ea-00186fc29798'}
CFIP=${CFIP:-'icook.hk'}
